...
import { StyleSheet, TextInput, AsyncStorage, ImageBackground, Image, Dimensions, TouchableNativeFeedback, ActivityIndicator, Text, View, TouchableOpacity } from 'react-native';
import { SimpleLineIcons, Ionicons, MaterialIcons, FontAwesome,Entypo } from '@expo/vector-icons';
    ...
    return(
        <View style={styles.root}>
            ...
            {/* <View style={styles.contentArea}> */}
             ...
             <View style={{flex:0.6,flexDirection:'row',backgroundColor:'#F9F9F9',borderColor:'#a9a9a9',borderBottomWidth:1,  alignItems: 'center' }}>
                ...
                <View style={{flex:0.7,marginTop:15}}>
                    <Text style={{ fontSize: 18, color: '#000', fontWeight: 'bold' }}>Enter Verification Code</Text>
                </View>
            </View>
            <View style={{flex:4.8}}>
...
const styles = StyleSheet.create({
    input: {
        marginLeft: 15, fontSize: 14, color: 'black', alignSelf: 'center'
